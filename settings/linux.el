...
(defun enable-hyper-super-modifiers-linux-x ()
  ...
  (define-key key-translation-map [<f12>] 'event-apply-hyper-modifier) ;H-
;;  (define-key key-translation-map ["<f12>"] 'event-apply-hyper-modifier)
;;  (define-key key-translation-map ["<f9>"] 'event-apply-super-modifier)
  (define-key key-translation-map [VoidSymbol] 'event-apply-super-modifier)
